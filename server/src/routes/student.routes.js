...
router.get("/course-evaluation", asyncHandler(studentController.courseEvaluation));
router.get("/registration-confirmation", asyncHandler(studentController.registrationConfirmation));
router.get("/course-drop", asyncHandler(studentController.courseDrop));
router.get("/semester-drop", asyncHandler(studentController.semesterDrop));
router.get("/program-change", asyncHandler(studentController.programChange));
router.get("/documents", asyncHandler(studentController.documents));
router.get("/teams-info", asyncHandler(studentController.teamsInfo));
